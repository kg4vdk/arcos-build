...
/* Compiler */
#define BUILD_COMPILER "gcc version 13.3.0 (Ubuntu 13.3.0-6ubuntu2~24.04) "

/* Configure arguments */
#define BUILD_CONFIGURE_ARGS ""

/* Build date */
#define BUILD_DATE "Tue Mar  4 18:40:49 UTC 2025"

/* Build host */
#define BUILD_HOST "arcOS"
...
#define FLARQ_BUILD_CXXFLAGS "-I$(srcdir) -I$(srcdir)/include -I$(srcdir)/fileselector -I$(srcdir)/flarq-src -I$(srcdir)/flarq-src/include -I$(srcdir)/xmlrpcpp -I/usr/include/cairo -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/cairo -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/pixman-1 -mno-omit-leaf-frame-pointer -pipe -Wall -fexceptions -O2 -I$(srcdir)/xmlrpcpp -DNDEBUG"
...
#define FLARQ_VERSION_PATCH ".8"

/* Fldigi authors */
#define FLDIGI_AUTHORS "Dave Freese, Stelios Bounanos, and others"

/* Fldigi cc compiler flags */
#define FLDIGI_BUILD_CFLAGS "-I$(srcdir) -I$(srcdir)/include -I$(srcdir)/irrxml -I$(srcdir)/libtiniconv -I$(srcdir)/fileselector -I$(srcdir)/xmlrpcpp -I$(srcdir)/mbedtls -pthread -I/usr/include/cairo -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/cairo -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/pixman-1 -mno-omit-leaf-frame-pointer -I/usr/include/opus -I/usr/include/x86_64-linux-gnu -D_REENTRANT -I/usr/include/libusb-1.0 -I/usr/include/libpng16 -pipe -Wall -fexceptions -O2 --param=max-vartrack-size=0 -I$(srcdir)/xmlrpcpp --param=max-vartrack-size=0 -DNDEBUG"

/* Fldigi cpp compiler flags */
#define FLDIGI_BUILD_CXXFLAGS "-I$(srcdir) -I$(srcdir)/include -I$(srcdir)/irrxml -I$(srcdir)/libtiniconv -I$(srcdir)/fileselector -I$(srcdir)/xmlrpcpp -I$(srcdir)/mbedtls -pthread -I/usr/include/cairo -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/cairo -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/pixman-1 -mno-omit-leaf-frame-pointer -I/usr/include/opus -I/usr/include/x86_64-linux-gnu -D_REENTRANT -I/usr/include/libusb-1.0 -I/usr/include/libpng16 -pipe -Wall -fexceptions -O2 --param=max-vartrack-size=0 -I$(srcdir)/xmlrpcpp --param=max-vartrack-size=0 -DNDEBUG"

/* Fldigi linker flags */
#define FLDIGI_BUILD_LDFLAGS "-lportaudio -lasound -lm -lpthread -lfltk_images -lfltk -lX11 -lX11 -lsndfile -lsamplerate -lpulse-simple -lpulse -pthread -lhamlib -lpng16 -ludev"
...
#define FLDIGI_VERSION_PATCH ".20"
...
/* hamlib version */
#define HAMLIB_BUILD_VERSION "4.5.5"
...
#define PACKAGE_STRING "fldigi 4.1.20"
...
/* png version */
#define PNG_BUILD_VERSION "1.6.43"

/* portaudio version */
#define PORTAUDIO_BUILD_VERSION "19"

/* pulseaudio version */
#define PULSEAUDIO_BUILD_VERSION "16.1"
...
/* sndfile version */
#define SNDFILE_BUILD_VERSION "1.2.2"
